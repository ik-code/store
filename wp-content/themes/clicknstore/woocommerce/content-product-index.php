	...
	<div class="choose-unit__card card" data-squre="<?php echo $product->get_attribute('square'); ?>">
		<div class="card__container">
			...
			<div class="card__block">
				<span class="card__size"><?php echo $product->name; ?></span>
				<span class="card__price"><?php echo $product->price; ?> KR/MÅN</span>
			</div>
		...
		if ($product->is_type( 'variable' ) && $available) {
			...
			?>
			<form class="variations_form cart" action="<?php echo get_permalink($product->get_id()); ?>" method="post" enctype="multipart/form-data" data-product_id="<?php echo $product->id; ?>" data-product_variations="<?php echo $variations_attr; // WPCS: XSS ok. ?>">
