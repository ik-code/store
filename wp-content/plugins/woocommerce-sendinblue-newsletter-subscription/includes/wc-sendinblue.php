...
class WC_Sendinblue {
    ...
    */
    ...
    {
        WC_Sendinblue::processInstallationInfo("logout");
        $setting = array();
    ...
    public static function ajax_validation_process()
    {
        ...
        try {
            ...
            if ( $apiClient->getLastResponseCode() === SibApiClient::RESPONSE_CODE_OK ) {
                ...
                WC_Sendinblue::processInstallationInfo("login");
    ...
    public static function processInstallationInfo($action)
    {
        ...
        if($action == "login")
        {
            ...
            if ( $apiClient->getLastResponseCode() === SibApiClient::RESPONSE_CODE_CREATED )
            {
                ...
                {
                    update_option(WC_Sendinblue::INSTALLATION_ID, $response["id"]);
                }
            }
        }
        elseif($action == "logout")
        {
            $installationId = get_option( WC_Sendinblue::INSTALLATION_ID );
